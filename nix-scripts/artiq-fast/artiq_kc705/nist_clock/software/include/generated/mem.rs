...
pub mod mem {
  ...
  pub const ROM_BASE: usize = 0x00af0000;
  pub const ROM_SIZE: usize = 0x00510000;

  pub const ETHMAC_BASE: usize = 0xb0000000;
  pub const ETHMAC_SIZE: usize = 0x00004000;

  pub const MAILBOX_BASE: usize = 0xf0000000;
  pub const MAILBOX_SIZE: usize = 0x0000000c;

  pub const FLASH_BOOT_ADDRESS: usize = 0x00b40000;
