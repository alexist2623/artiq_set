...
pub mod sdram_phy {
    ...
    pub unsafe fn dfii_pird_address_write(a: u16) { csr::dfii::pi0_address_write(a) }
    pub unsafe fn dfii_piwr_address_write(a: u16) { csr::dfii::pi2_address_write(a) }

    pub unsafe fn dfii_pird_baddress_write(a: u8) { csr::dfii::pi0_baddress_write(a) }
    pub unsafe fn dfii_piwr_baddress_write(a: u8) { csr::dfii::pi2_baddress_write(a) }

    pub unsafe fn command_prd(cmd: u8) { command_p0(cmd) }
